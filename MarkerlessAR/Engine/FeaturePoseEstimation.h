#ifndef _FEATURE_POSE_ESTIMATION_H_
#define _FEATURE_POSE_ESTIMATION_H_
...
class FeaturePoseEstimation
{
public:
    FeaturePoseEstimation(void);
    ~FeaturePoseEstimation(void);
	...
	//120325 cwj DirectX를 이용한 프로젝션/뷰 행렬 계산파일
